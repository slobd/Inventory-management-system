...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
    ...
    axios.get("get_clients_without_paginate").then(function (_ref) {
      var data = _ref.data;
      _this10.clients = data;
      var createdUser = data.filter(function (item) {
        return item.name == _this10.client.name;
      });
      _this10.selectedClient = createdUser.length ? createdUser[0] : {};
      _this10.sale.client_id = createdUser.length ? createdUser[0].id : "";
    });
