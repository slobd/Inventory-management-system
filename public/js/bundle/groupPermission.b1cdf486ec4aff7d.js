...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Get_Workspace_Info: function Get_Workspace_Info(id) {
      ...
      axios.get("get_workspace_info/".concat(id)).then(function (response) {
        _this3.workspace_owner = response.data.owner;
    ...
    Get_Profile_Info: function Get_Profile_Info() {
      ...
      axios.get("get_user_profile").then(function (response) {
        _this4.current_user = response.data.user;
        if (response.data.user.workspace_id) {
          _this4.Get_Workspace_Info(response.data.user.workspace_id);
        }
  ...
  created: function created() {
    ...
    Fire.$on("Delete_role", function () {
      setTimeout(function () {
        _this5.Get_Roles(_this5.serverParams.page);
      }, 500);
    });
  }
});
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return !(props.row.id === 1 || props.row.id === 2 && _vm.current_user.workspace_id) && _vm.current_user.role_id <= 2 ? [props.column.field == "actions" ? _c("span", [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("permissions_edit") ? _c("router-link", {
          directives: [{
            name: "b-tooltip",
    ...
    slot: "table-actions"
  }, [_vm.currentUserPermissions && _vm.currentUserPermissions.includes("permissions_add") && (_vm.current_user.id === 1 || _vm.current_user.id === _vm.workspace_owner) && _vm.current_user.role_id <= 2 ? _c("router-link", {
