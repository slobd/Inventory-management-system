...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["currentUser"])), {}, {
    //---- update Params Table
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [props.column.field == "actions" ? _c("span", [props.row.workspace_id || _vm.currentUser.role_id === 1 ? _c("a", {
          directives: [{
            name: "b-tooltip",
        ...
        })]) : _vm._e(), _vm._v(" "), props.row.workspace_id || _vm.currentUser.role_id === 1 ? _c("a", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
        ...
        })]) : _vm._e()]) : props.column.field == "BaseUnit" ? _c("div", [props.row.base_unit_name != "" ? _c("span", [_vm._v(_vm._s(props.row.base_unit_name))]) : _c("span", [_vm._v("N/D")])]) : _vm._e()];
      }
    }], null, false, 3075973675)
  }, [_c("div", {
